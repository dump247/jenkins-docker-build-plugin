...
public class AutoScalingDockerCloud extends DockerCloud {
    ...
    public AutoScalingDockerCloud(String name, final String asgString, final int dockerPort, final String labelString, final int maxExecutors, final boolean tlsEnabled, final String credentialsId, final String directoryMappingsString, boolean allowCustomImages, String slaveJarPath) {
